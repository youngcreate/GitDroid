package com.youngcreate.gitdroid.github.network;

import com.youngcreate.gitdroid.github.hotrepo.repolist.model.RepoResult;
import com.youngcreate.gitdroid.github.hotuser.UsersResult;
import com.youngcreate.gitdroid.github.login.model.AccessTokenResult;
import com.youngcreate.gitdroid.github.login.model.User;
import com.youngcreate.gitdroid.github.repoinfo.RepoContentResult;
...
public class GitHubClient implements GitHubApi {
    ...
    @Override
    public Call<UsersResult> searchUsers(@Query("q") String q, @Query("page") int pageId) {
        return gitHubApi.searchUsers(q, pageId);
    }
